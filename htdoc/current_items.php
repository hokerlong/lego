...
$Taobao = array();
$ret = db_query("(SELECT * FROM Top_SellerPrice ORDER BY Price, Volume) AS TEMP", array("LegoID", "MIN(Price) AS Low", "AVG(Price) AS Avg", "Nid AS ItemID", "Volume", "SUM(Volume) AS Total"), "1=1 GROUP BY LegoID");
